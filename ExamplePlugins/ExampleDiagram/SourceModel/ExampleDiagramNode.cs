...
{
    public class ExampleDiagramNode : Node
    {
        // Our Private Fields
        ...
        protected override IDocumentation CreateDocumentation()
        {
            ...
            {
                Description = "An Example Node for the Example Diagram",
                Name = "Example Node",
                InstanceName = "Example Node"
            };
        }
        ...
        public static ExampleDiagramNode Create(IElementCreateInfo info)
        {
            var node = new ExampleDiagramNode();
            node.Init(info);
            return node;
        }
